...
CREATE TABLE `admin_role` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='后台角色表';
INSERT INTO admin.admin_role
(id, name, permissions, remark, create_time)
VALUES(1, '超级管理员', 'admin', NULL, '2022-11-17 16:47:30');
...
(id, `user`, password, role_ids, create_time)
VALUES(1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', '1', '2022-11-14 11:34:03');